    ...
    <section id="contacto" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            {/* Location */}
            <div className="flex items-start space-x-4 p-6 bg-[#f5f0e8] rounded-2xl">
              <div className="flex-shrink-0 w-14 h-14 bg-[#d4af37] rounded-xl flex items-center justify-center">
                <MapPin className="w-7 h-7 text-white" />
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-1">Ubicación</h3>
                <p className="text-gray-600">Juan Jaramillo 8-38</p>
            ...
            <div className="flex items-start space-x-4 p-6 bg-[#f5f0e8] rounded-2xl">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-1">Teléfono / WhatsApp</h3>
                <a 
            ...
            <a
              ...
              className="flex items-center justify-center space-x-3 bg-[#25D366] text-white p-6 rounded-2xl font-semibold text-lg hover:bg-[#20bd5a] transition-colors shadow-lg"
            >
